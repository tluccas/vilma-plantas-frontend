...
export default function Hero() {
  ...
  return (
    <section className="px-4 sm:px-6 lg:px-8 py-4 lg:py-6 bg-(--color-background)">
      <div className="max-w-6xl mx-auto w-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-10 items-center">
          ...
          <div className="flex flex-col space-y-4 lg:space-y-6 text-center lg:text-left order-2 lg:order-1">
            ...
            >
              Descubra nossa coleção exclusiva de plantas que trazem vida,
              purificam o ar e criam ambientes únicos e acolhedores.
            </p>

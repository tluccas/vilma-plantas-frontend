...
export default function Delivery() {
  return (
    <section className="top-categories border-t border-gray-300 px-4 sm:px-6 lg:px-8 py-6">
      <h2 className="subtitle mt-2 text-xl sm:text-2xl font-semibold text-heading text-center">Entregamos <span className="font-bold text-(--color-secondary)">Para</span></h2>
